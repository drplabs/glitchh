import BackgroundImage from "@/public/images/home112.jpeg";
  ...
  return (
    ...
    <div className="absolute inset-0">
      {/* <Image
        ...
        layout="fill"
        className=" blur-sm brightness-95"
        quality={100}
      /> */}
    </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20 ">
            <h2 className="h2 mb-4 text-white">The majority our customers do not understand their workflows.</h2>
            <p className="text-xl text-white">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
          </div>
